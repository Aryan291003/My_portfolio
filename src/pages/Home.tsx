...
const Home: React.FC = () => {
  ...
  <Link key={index} to={`/projects/${project.id}`}>
    <div
      className="group relative w-[400px] bg-[#1a1a1a] rounded-xl shadow-lg flex-shrink-0 cursor-pointer overflow-hidden hover:scale-105 transition-transform duration-300"
    >
      <img
        src={project.image}
        alt={project.title}
      ...
      <section className="relative bg-black py-16 px-8">
        <h2 className="text-3xl font-semibold mb-8">Upcoming Skills</h2>
        <div
          ref={uskillRef}
          className="flex space-x-6 overflow-x-hidden scroll-smooth py-2"
        >
